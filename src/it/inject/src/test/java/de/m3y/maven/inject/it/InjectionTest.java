...
public class InjectionTest {
    ...
    public void testInject() {
        ...
        // Build time
        assertEquals("", // Last initialization in constructor wins, which is the original one
                new ExampleInjection().buildTimeDefault);

        assertEquals("To be replaced", // Last initialization in constructor wins, which is the original one
                new ExampleInjection().buildTimePublic);
        assertEquals(expectedBuildTime, // Works because declared as final
                new ExampleInjection().buildTimePublicFinal);
        assertEquals("To be replaced", //  Last initialization in constructor wins, which is the original one
                new ExampleInjection().getBuildTimePublicFinal());
